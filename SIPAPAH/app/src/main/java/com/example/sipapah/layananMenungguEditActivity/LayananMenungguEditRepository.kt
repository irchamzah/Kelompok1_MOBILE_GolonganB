...
class LayananMenungguEditRepository(var application: Application){
    ...
    fun update(data: Layanan, file: File){
        ...
        ApiConfig.instanceRetrofit.setlayananedit(id,categoryId,tanggalJemput,dataKeterangan, fileImage).enqueue(object : Callback<ResponModel> {
